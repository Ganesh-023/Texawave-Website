  ...
  return (
    <AnimatedShell>
      ...
      <main className="overflow-hidden pt-[110px]">
        {/* ── Hero ── */}
        <section className="relative bg-bg-secondary border-b border-border-primary px-5 py-20 lg:px-8">
          ...
          <div className="relative mx-auto max-w-7xl">
            ...
            <h1 className="mt-3 max-w-3xl text-4xl font-black text-text-primary md:text-6xl">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="project-card-body flex flex-1 flex-col p-6">
                      ...
                      <h2 className="text-xl font-black text-text-primary">{work.title}</h2>
        ...
        <section className="bg-bg-secondary border-t border-border-primary px-5 py-16 text-text-primary lg:px-8">
          <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
            <p className="text-sm font-bold uppercase tracking-[0.18em] text-signal">Start a project</p>
            <h2 className="mt-3 text-4xl font-black md:text-5xl text-text-primary">Have a product in mind?</h2>
