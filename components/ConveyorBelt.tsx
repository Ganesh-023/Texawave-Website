  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(0,229,168,0.10) 0%, transparent 70%)" }}
      />
      ...
      >
        ...
        <line x1="0" y1="540" x2="1200" y2="140" stroke="#00E5A8" strokeWidth="0.5" strokeDasharray="4 20" strokeOpacity="0.2" />
        ...
        <polyline points="24,676 24,644 56,644" fill="none" stroke="#00E5A8" strokeWidth="1.5" strokeOpacity="0.5" />
        <polyline points="1176,676 1176,644 1144,644" fill="none" stroke="#00E5A8" strokeWidth="1.5" strokeOpacity="0.5" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 pb-0 pt-20 text-center lg:px-8">
        ...
        >
          ...
          <span style={{ background: "linear-gradient(90deg,#00D4FF,#00E5A8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
            Texawave
          </span>
        </h2>
      ...
      >
        ...
        <div
          ...
          style={{ transform: "translateX(-50%) rotateX(72deg) rotateZ(-18deg)", width: "85%", height: "2px",
            background: "linear-gradient(90deg, transparent 0%, rgba(0,229,168,0.3) 30%, rgba(0,229,168,0.3) 70%, transparent 100%)" }}
        />
