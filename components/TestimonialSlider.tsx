...
const PARTICLES_DATA = [
  { left: "5%", top: "40%", size: 6, driftX: 40, driftY: -80, duration: "12s", delay: "0s", opacity: 0.4 },
  { left: "15%", top: "70%", size: 4, driftX: -30, driftY: -60, duration: "16s", delay: "3s", opacity: 0.3 },
  { left: "25%", top: "20%", size: 5, driftX: 50, driftY: -100, duration: "14s", delay: "1s", opacity: 0.4 },
  { left: "40%", top: "85%", size: 7, driftX: 20, driftY: -70, duration: "18s", delay: "5s", opacity: 0.3 },
  { left: "50%", top: "15%", size: 4, driftX: -20, driftY: -90, duration: "15s", delay: "2s", opacity: 0.5 },
  { left: "60%", top: "75%", size: 5, driftX: 30, driftY: -50, duration: "13s", delay: "4s", opacity: 0.4 },
  { left: "75%", top: "30%", size: 6, driftX: -40, driftY: -80, duration: "17s", delay: "6s", opacity: 0.3 },
  { left: "85%", top: "80%", size: 5, driftX: 20, driftY: -60, duration: "14s", delay: "2.5s", opacity: 0.4 },
  { left: "95%", top: "45%", size: 4, driftX: -30, driftY: -70, duration: "15.5s", delay: "1.5s", opacity: 0.3 },
  { left: "30%", top: "50%", size: 5, driftX: 30, driftY: -90, duration: "13.5s", delay: "4.5s", opacity: 0.4 }
];
      ...
      <div
        ...
        style={{
          ...
          boxShadow: isHoverActive
            ? "0 20px 40px rgba(0, 230, 118, 0.2), 0 0 15px rgba(0, 230, 118, 0.1), 0 0 0 1px rgba(0, 230, 118, 0.15)"
            : isActive
              ? "0 10px 30px rgba(0, 230, 118, 0.1), 0 0 0 1px rgba(0, 230, 118, 0.08)"
      ...
      >
        ...
        {isActive && (
          <>
            <svg className="pointer-events-none absolute left-3.5 top-3.5" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
              <polyline points="0,16 0,0 16,0" fill="none" stroke="#00E676" strokeWidth="1.5" strokeOpacity="0.75" />
            </svg>
            <svg className="pointer-events-none absolute right-3.5 top-3.5" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
              <polyline points="0,0 16,0 16,16" fill="none" stroke="#00E676" strokeWidth="1.5" strokeOpacity="0.75" />
            </svg>
            <svg className="pointer-events-none absolute bottom-3.5 left-3.5" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
              <polyline points="0,0 0,16 16,16" fill="none" stroke="#00E676" strokeWidth="1.5" strokeOpacity="0.75" />
            </svg>
            <svg className="pointer-events-none absolute bottom-3.5 right-3.5" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
              <polyline points="16,0 16,16 0,16" fill="none" stroke="#00E676" strokeWidth="1.5" strokeOpacity="0.75" />
            </svg>
          </>
        )}
        ...
        <div className="mb-5 flex items-center justify-between">
          <span
            ...
            style={{ color: isActive ? "#00E676" : "var(--text-secondary)", opacity: isActive ? 1 : 0.6 }}
          >
            {testimonial.blueprintId}
          </span>
          {isActive && (
            <span
              className="flex items-center gap-1.5 rounded-full px-3 py-0.5 text-[9px] font-bold uppercase tracking-wider bg-[#00E676]/10 border border-[#00E676]/25 text-[#00E676]"
            >
        ...
        <div className="mb-4 flex items-center gap-0.5" aria-label="5 star rating">
          {[0, 1, 2, 3, 4].map((i) => (
            <Star
              ...
              size={13}
              aria-hidden="true"
              style={{ color: "#00E676", fill: "#00E676", opacity: isActive ? 1 : 0.4 }}
            />
          ))}
        </div>
    ...
    >
      ...
      <style>{`
        ...
        @keyframes pulseOpacityFast {
          0%, 100% { opacity: 0.3; }
          50% { opacity: 0.95; filter: drop-shadow(0 0 6px #00E676); }
        }
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0, 230, 118, 0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(0, 230, 118, 0.05) 1px, transparent 1px)",
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden opacity-30 select-none">
        ...
        >
          ...
          <circle cx="380" cy="220" r="4.5" fill="#00E676" className="node-pulse-fast" />
          <circle cx="440" cy="280" r="4" fill="#00D4FF" className="node-pulse-slow" />
          <circle cx="960" cy="280" r="4" fill="#00E676" className="node-pulse-fast" />
          ...
          <circle cx="410" cy="100" r="4" fill="#00E676" className="node-pulse-fast" />
          <circle cx="990" cy="100" r="4" fill="#00D4FF" className="node-pulse-slow" />
          <circle cx="1050" cy="160" r="3.5" fill="#00E676" className="node-pulse-fast" />
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 py-14 lg:px-8 lg:py-16 z-10 flex flex-col justify-between">
        ...
        <div className="mb-10 text-center">
          <div
            className="testimonial-fade-el mb-4 inline-flex items-center gap-2 rounded-full px-4.5 py-1 text-[11px] font-mono font-bold uppercase tracking-[0.22em] border border-[#00E676]/25 text-[#00E676] bg-[#00E676]/8"
          >
          ...
          <h2 className="testimonial-fade-el mx-auto mt-2 max-w-4xl text-3xl font-black leading-tight text-text-primary md:text-5xl tracking-tight">
            ...
            <span className="text-[#00E676] inline-block font-black">
              Deliver Results
            </span>
          </h2>
        ...
        <div className="testimonial-fade-el mx-auto mb-12 flex flex-wrap justify-center gap-6 sm:gap-10 md:gap-14 border-y border-border-primary/50 py-5 max-w-4xl w-full">
          ...
          <div className="flex items-center gap-3">
            <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#00E676]/10 text-[#00E676]">
              <Star size={17} fill="#00E676" />
            </span>
            <div>
        ...
        <div className="mt-4 flex flex-col items-center gap-5">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-xl border border-border-primary bg-bg-card/30 backdrop-blur-sm text-text-secondary transition-all duration-300 hover:-translate-y-0.5 hover:border-[#00E676]/40 hover:text-[#00E676] hover:shadow-[0_0_12px_rgba(0,230,118,0.15)]"
            >
              <ChevronLeft size={18} />
            </button>
