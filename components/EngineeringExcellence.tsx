...
const DISCIPLINES = [
  {
    ...
    icon: Code2,
    shortDesc: "End-to-end digital product development and connected platform solutions.",
    capabilities: [
  ...
  },
  {
    ...
    icon: Cpu,
    shortDesc: "Power-efficient smart hardware engineering.",
    capabilities: [
  ...
  },
  {
    ...
    icon: Cog,
    shortDesc: "Robust product design from concept validation to production readiness.",
    capabilities: [
  ...
  },
  {
    ...
    title: "Procurement",
    icon: Package,
    shortDesc: "Strategic sourcing and manufacturing support for seamless product realization.",
    capabilities: [
  ...
  return (
    <section
      ...
      style={{
        ...
        minHeight: "100vh",
        paddingBlock: "clamp(60px, 8vh, 110px)",
      }}
    >
      ...
      >
        ...
        <div ref={headerRef} className="mb-12 lg:mb-16 text-center" style={{ opacity: 0 }}>
          ...
          >
            From concept to production, TexaWave integrates software, electrical, mechanical, and procurement expertise to accelerate product development.
          </p>
        </div>
