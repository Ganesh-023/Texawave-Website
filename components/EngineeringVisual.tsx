...
function TimelineNode({ stage, idx, activeStage, seekToStage }: TimelineNodeProps) {
  ...
  return (
    ...
    >
      ...
      <span
        className={`mb-2 h-2.5 w-2.5 rounded-full border transition-all duration-300 ${
          isActive
            ? "border-[#39B54A] bg-[#39B54A] shadow-[0_0_12px_#39B54A,0_0_6px_#39B54A] scale-125"
            : "border-white/30 bg-white/10 group-hover:border-white/60"
        }`}
      />
      {/* Stage Code Name */}
      <span className={`font-mono text-[11px] md:text-xs font-bold tracking-wider leading-none transition-all duration-300 ${
        isActive ? "scale-105 text-[#39B54A]" : ""
      }`}>
        {stage.name}
      </span>
      ...
      <span
        ref={tooltipRef}
        style={{ display: "none" }}
        className="absolute bottom-full mb-2.5 whitespace-nowrap rounded bg-ink px-2.5 py-1 text-[10px] font-medium tracking-wide text-white border border-white/10 shadow-lg pointer-events-none"
      >
        {stage.desc}
      </span>
    </button>
...
export function EngineeringVisual({ startAnimation = false }: EngineeringVisualProps) {
  ...
  // Play timeline when parent trigger starts
  useEffect(() => {
    ...
    >
      ...
      >
        ...
        <div className="relative flex-1 flex items-center justify-center min-h-[300px] md:min-h-[360px] w-full" style={{ transform: "translateZ(30px)" }}>
          ...
          >
            <defs>
              ...
              {/* Green Glow Filter */}
              <filter id="green-glow-filter" x="-30%" y="-30%" width="160%" height="160%">
              ...
              <filter id="copper-glow" x="-30%" y="-30%" width="160%" height="160%">
                <feGaussianBlur stdDeviation="3" result="blur" />
                <feColorMatrix type="matrix" values="
                  0 0 0 0 0.92
                  0 0 0 0 0.35
            ...
            {/* Wrapper for internal components to scale them up */}
            <g id="internal-components" transform="translate(260, 240) scale(1.12) translate(-260, -240)">
              ...
              <g id="stage-1-idea">
                ...
                <g stroke="#38bdf8" strokeWidth="1.25" fill="none" filter="url(#cyan-glow)">
              ...
              <g id="stage-3-pcb">
                ...
                <g strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" fill="none">
                  ...
                  <g stroke="url(#copper-grad)" filter="url(#copper-glow)">
                  ...
                  <g stroke="#39B54A" filter="url(#green-glow)">
              ...
              {/* ══════════════ ANIMATED DATA FLOW PARTICLES (INTERNAL TRACES) ══════════════ */}
              <g id="pcb-flow-particles-internal" strokeLinecap="round" fill="none" opacity="1">
            ...
            <g id="hero-structural-traces" opacity="0.8">
              <path
                data-trace
            ...
            {/* ══════════════ ANIMATED DATA FLOW PARTICLES (OUTER TRACES) ══════════════ */}
            {/* Highly performant SVG particles using strokeDasharray looping */}
            <g id="pcb-flow-particles-outer" strokeLinecap="round" fill="none" opacity="1">
        ...
        <div className="relative z-20 mt-4 rounded-xl border border-white/8 bg-black/40 px-3 py-3 backdrop-blur-md">
          ...
          <div className="absolute top-[22px] left-[8.33%] right-[8.33%] h-[2px] bg-white/12 pointer-events-none">
            {/* Active filled line width driven by react activeStage index */}
            <div
              className="h-full bg-gradient-to-r from-[#39B54A] to-[#22d3ee] transition-all duration-500 ease-out shadow-[0_0_10px_#39B54A,0_0_5px_#22d3ee]"
