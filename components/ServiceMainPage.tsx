      ...
      <section className="bg-bg-primary py-20">
        <div className="mx-auto w-full max-w-[1400px] px-[clamp(1rem,4vw,4rem)] grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div data-reveal>
            ...
            <Link
              href="/contact"
              className="btn-premium mt-8 inline-flex items-center gap-2 rounded-xl border border-signal px-5 py-3 text-sm font-bold text-signal hover:bg-signal/10 transition-colors"
            >
